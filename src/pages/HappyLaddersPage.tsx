...
import { HAPPY_LADDERS_GAME_URL } from '../../constants/global';
import { ENCRYPTION_KEY, IV_LENGTH } from '../../constants/global';
import { encrypt } from '../utils/util';

export default function HappyLaddersPage() {
    ...
    const generateGameUrl = async () => {
        ...
        const url = `${HAPPY_LADDERS_GAME_URL}?${requestParamsString}`;
